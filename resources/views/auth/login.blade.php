        ...
        <div class="login-card-premium">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group-premium">
                    ...
                    <input type="password" name="password" class="input-premium @error('password') is-invalid @enderror" required placeholder="••••••••">
                    @error('password')
                        <span class="invalid-feedback-premium">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="login-footer">
                <p>অ্যাকাউন্ট নেই? <a href="{{ route('register') }}">রেজিস্টার করুন</a></p>
                <hr>
