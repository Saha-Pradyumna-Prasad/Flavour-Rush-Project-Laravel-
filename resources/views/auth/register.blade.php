        ...
        <div class="register-card-premium">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group-premium">
                    ...
                    <input type="text" name="name" class="input-premium @error('name') is-invalid @enderror" 
                           value="{{ old('name') }}" required autofocus placeholder="আপনার পুরো নাম">
                    @error('name')
                        <span class="invalid-feedback-premium">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group-premium">
                    ...
                    <input type="email" name="email" class="input-premium @error('email') is-invalid @enderror" 
                ...
                <div class="form-group-premium">
                    ...
                    <input type="password" name="password" class="input-premium @error('password') is-invalid @enderror" required placeholder="মিনিমাম ৬ ডিজিট">
                    @error('password')
                        <span class="invalid-feedback-premium">{{ $message }}</span>
                    @enderror
            ...
            <div class="register-footer">
                <p>ইতিমধ্যে একাউন্ট আছে? <a href="{{ route('login') }}">লগইন করুন</a></p>
            </div>
        </div>
    </div>
</div>
