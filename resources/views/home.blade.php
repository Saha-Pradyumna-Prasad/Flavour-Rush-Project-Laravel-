...
<div class="container">
    ...
    <div class="hero-wrapper">
        <div class="hero-slider" id="heroSlider">
            @foreach($sliderFoods as $index => $food)
                <div class="slide {{ $index == 0 ? 'active' : '' }}" 
                    ...
                    <div class="slide-content">
                        ...
                        <div class="slide-price">
                            শুরু মাত্র <span>৳{{ $food->price }}</span>
                        </div>
                        <a href="{{ url('/food/' . $food->category) }}" class="btn btn-order">
    ...
    <div class="row g-4 category-grid">
        <div class="col-md-4">
            <div class="category-card-premium" onclick="location.href='{{ url('/food/Burger') }}'">
                ...
                <div class="card-content">
                    <h3>🍔 বার্গার</h3>
                    <div class="item-count">{{ $burgerCount }} টি প্রিমিয়াম আইটেম</div>
        ...
        <div class="col-md-4">
            <div class="category-card-premium" onclick="location.href='{{ url('/food/Pizza') }}'">
                <div class="card-img-wrapper">
                ...
                <div class="card-content">
                    <h3>🍕 পিৎজা</h3>
                    <div class="item-count">{{ $pizzaCount }} টি প্রিমিয়াম আইটেম</div>
                    <div class="explore-link">
                        এক্সপ্লোর করুন <i class="fas fa-arrow-right"></i>
                    </div>
                </div>
        ...
        <div class="col-md-4">
            <div class="category-card-premium" onclick="location.href='{{ url('/food/Dessert') }}'">
                <div class="card-img-wrapper">
                ...
                <div class="card-content">
                    <h3>🍰 ডেজার্ট</h3>
                    <div class="item-count">{{ $dessertCount }} টি প্রিমিয়াম আইটেম</div>
                    <div class="explore-link">
                        এক্সপ্লোর করুন <i class="fas fa-arrow-right"></i>
                    </div>
                </div>
                ...
                <a href="#" class="offer-card">
                    ...
                    <div class="offer-overlay">
                        ...
                        {{-- <span class="shop-now-btn">
                            অর্ডার করুন <i class="fas fa-arrow-right"></i>
                        </span> --}}
                    </div>
                </a>
            </div>
