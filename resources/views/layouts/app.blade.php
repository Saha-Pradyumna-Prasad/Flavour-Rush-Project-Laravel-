...
<nav class="navbar navbar-expand-lg sticky-top">
    <div class="container">
        ...
        {{-- ekahne mobile e toggle 3 stick thakbe jetate click korle navbar open hobe.niche JS part e toggle er kaj ta kortese --}}
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ url('/food/Burger') }}">🍔 বার্গার</a></li>
                        <li><a class="dropdown-item" href="{{ url('/food/Pizza') }}">🍕 পিৎজা</a></li>
                        <li><a class="dropdown-item" href="{{ url('/food/Dessert') }}">🍰 ডেজার্ট</a></li>
                    </ul>
                </li>
...
<footer class="footer">
    <div class="container text-center">
        ...
        <div class="mt-3">
            <small class="text-secondary opacity-75">&copy; {{ date('Y') }} Flavor Rush. All rights reserved.</small>
        </div>
    </div>
</footer>
...
{{-- <script>
    // auto-dismiss alerts after 5 seconds (unchanged functionality)
    setTimeout(function() {
    ...
    // optional: dropdown hover for better desktop UX (no backend impact)
